...
<html>
<head>
<title>DMCC | Admin Manage Feedbacks</title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Manage Feedbacks</li>
            </ol>
					  ...
					  <h2>Manage Feedbacks</h2>
						...
						<thead>
							...
							<?php $sql = "SELECT * from feedback";
								...
								{	
									$res1 = findUserData($result->userid);
								...
								<td><?php echo htmlentities($details['contact']);?></td>
								<td><?php echo htmlentities($result->message);?></td>
								<td><?php echo htmlentities($result->feedback_date);?></td>
