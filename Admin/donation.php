...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Manage Donation</li>
            </ol>
					  ...
					  <h2>Donation Details</h2>
						...
						<thead>
							...
							<tbody>
								...
								<td><?php echo htmlentities($result->amount);?> Rs.</td>
