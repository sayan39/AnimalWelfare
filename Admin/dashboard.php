...
<!--header end here-->
		...
		<div class="four-grids">
			<div class="col-md-3 four-grid">
				<div class="four-agileits  bg-primary">
					<div class="icon">
			...
			<div class="col-md-3 four-grid">
				<div class="four-agileits bg-success">
					<div class="icon">
						<i class="fa fa-list-alt" aria-hidden="true" style="font-size: 30px;"></i>
					</div>
					<div class="four-text">
			...
			<div class="col-md-3 four-grid">
				<div class="four-agileits bg-warning">
					<div class="icon">
						<i class="fa fa-product-hunt" aria-hidden="true" style="font-size: 30px;"></i>
					</div>
					<div class="four-text">
						<h3>Donation</h3>		
						<h4>    </h4>
			...
			<div class="col-md-3 four-grid">
				<div class="four-agileits bg-info">
					<div class="icon">
